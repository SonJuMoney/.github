# <div style="display: flex; align-items: center; justify-content: center; height: 100px;"><img src="https://github.com/user-attachments/assets/00a95146-b4a6-4477-ab71-064b9031baeb" alt="손주머니" width="50" height="50" style="margin-top: 10px">손주머니</div>
#### 세대 간 정서적 교류와 금융 활동을 결합한 가족 중심의 비대면 금융 플랫폼,  "손주머니" 👨🏻‍👩🏻‍👧🏻‍👦🏻
###### 디지털 시대에 변화하는 가족 소통 방식과 세대 간 격차를 해결하기 위해, </br>손주머니는 조부모와 손주를 포함한 가족 구성원들이 자연스럽게 교류할 수 있는 새로운 형태의 소통 채널을 제공합니다. 
###### 금융 활동을 매개로 한 대화와 상호작용을 통해 가족 간의 정서적 유대를 강화하고, 동시에 금융 교육 효과를 제공하는 혁신적인 서비스를 목표로 합니다.
...
## 🛠 주요 기능
### 1. 용돈 보내기
#### ✅ 용돈과 감사 인사를 주고 받을 수 있습니다.
#### ✅ 사진/영상 및 메시지를 첨부하여 마음을 전할 수 있습니다.
...
### 3. 메세지 적금
#### ✅ 손주 명의의 적금을 가입하고 자동 이체, 금액을 설정할 수 있습니다.
#### ✅ 사랑이 가득 담긴 메세지와 함께 적금을 납입하고 이는 만기시에 편지로 제작됩니다.
<img width="1920" alt="Image" src="https://github.com/user-attachments/assets/ff01e683-ce68-4750-b327-02dfeae0d296" />

### 4. 가족 소식 피드
#### ✅ 가족 피드에 서로의 일상을 공유하고 댓글로 소통할 수 있습니다.
#### ✅ 용돈을 주고 받으며 보낸 메세지 또한 피드에 기록됩니다.
